...
<head>
    ...
    <title>Kelola Produk - Bandeng Bu Yuwono</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h2>Daftar Varian</h2>
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModalcreate" class="btn btn-info col-md-2">Tambah Varian</button>
                                </div>
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                             $varians = mysqli_query($conn, "SELECT * FROM varian_produk ORDER BY idvarian ASC");
                            $no = 1;
                            while ($v = mysqli_fetch_array($varians)) {

                                            ?>

                                                <tr>
                                                <td><?php echo $no++; ?></td>
                                    <td><?php echo $v['idproduk']; ?></td>
                                    <td><?php echo $v['varian_nama']; ?></td>
                                    <td><?php echo number_format($v['harga'], 0, ',', '.'); ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="create_variant.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>Nama Produk</label>
                        <select name="idproduk" class="form-control" required>
                                <option selected disabled>Pilih Produk</option>
                                <?php
                                $yet = mysqli_query($conn, "SELECT * FROM produk ORDER BY namaproduk ASC") or die(mysqli_error($conn));
                                while ($d = mysqli_fetch_array($yet)) {
                                ?>
                                    <option value="<?php echo $d['idproduk']; ?>"><?php echo htmlspecialchars($d['namaproduk']); ?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <input name="varian_nama" type="text" class="form-control" placeholder="Masukkan nama varian" required >                        
                    </div>
                    <div class="form-group">
                        <label>Harga</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success" name="createvariant">Tambah Varian</button>
                    </div>
                </form>
            </div>
    </div>
                    ...
                    <form action="update_produk.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="idkategori" class="form-control" required>
                                ...
                                ?>
                                    <option value="<?php echo $d['idkategori']; ?>"><?php echo htmlspecialchars($d['namakategori']); ?></option>
                                <?php
                                }
                                ?>
                            </select>
