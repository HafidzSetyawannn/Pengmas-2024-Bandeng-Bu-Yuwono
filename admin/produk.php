                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h2>Daftar Produk</h2>
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModalcreate" class="btn btn-info col-md-2">Tambah Produk</button>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="create_produk.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Nama Produk</label>
                            <input name="namaproduk" type="text" class="form-control" placeholder="Masukkan nama produk" required autofocus>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="deskripsi" type="text" class="form-control" placeholder="Masukkan deskripsi produk" required>
                        </div>
                        <div class="form-group">
                            <label>Rating (1-5)</label>
                            <input name="rate" type="number" class="form-control" min="1" max="5" placeholder="Masukkan rating" required>
                        </div>
                        <div class="form-group">
                            <label>Harga Sebelum Diskon</label>
                            <input name="hargabefore" type="number" class="form-control" placeholder="Masukkan harga sebelum diskon">
                        </div>
                        <div class="form-group">
                            <label>Harga Setelah Diskon</label>
                            <input name="hargaafter" type="number" class="form-control" placeholder="Masukkan harga setelah diskon">
                        </div>
                        <div class="form-group">
                            <label>Gambar</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" name="createproduct">Tambah Produk</button>
                        </div>
                    </form>
                </div>
            </div>
