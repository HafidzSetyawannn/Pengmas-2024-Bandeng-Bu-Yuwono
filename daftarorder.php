...
// Check if $fetc is not null
if ($fetc) {
	$orderidd = $fetc['orderid'];
} else {
	// Handle the case when no cart is found
	$orderidd = null; // or some default value
}
...
<head>
	<title>Bandeng Bu Yuwono - Daftar Belanja</title>
	<!-- for-mobile-apps -->
						...
						<tr class="rem1">
							<form method="post">
								...
								<td class="invert">
									...
									<!-- perhitungan ongkir ni gayss -->
									Rp<?php $ongkir = 10000;
										$ordid = $b['orderid'];
										$result1 = mysqli_query($conn, "
										SELECT SUM(d.qty * vp.harga) + $ongkir AS count
										FROM detailorder d
